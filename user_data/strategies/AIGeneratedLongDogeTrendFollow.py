...
class AIGeneratedLongDogeTrendFollow(SampleStrategy):
    """
    ...
    can_short = True
    minimal_roi = {"0": 0.05, "30": 0.025, "90": 0.0}
    stoploss = -0.02
    trailing_stop = True
    ...
    "archetype": "trend",
    "bb_tolerance": 0.005,
    "class_name": "AIGeneratedLongDogeTrendFollow",
    "generated_by": "llm",
    "name": "long_doge_trend_follow",
    "reason": "DOGE is a standout with EMA20>EMA50>EMA200 across all timeframes (5m, 15m, 1h) and positive recent returns. The strong uptrend, supported by volume (15m ratio 1.49), makes it a candidate for continued momentum. Use tighter trailing to lock gains.",
