...
class AIGeneratedShortBreakoutWeakHands(SampleStrategy):
    """
    ...
    can_short = True
    minimal_roi = {"0": 0.06, "30": 0.03, "90": 0.0}
    stoploss = -0.03
    trailing_stop = True
    ...
    "archetype": "breakout",
    "bb_tolerance": 0.005,
    "class_name": "AIGeneratedShortBreakoutWeakHands",
    "generated_by": "llm",
    "name": "short_breakout_weak_hands",
    "reason": "Capitalize on the broad bearish bias: many pairs (BTC, ETH, SOL, LINK, UNI) show EMA20<EMA50<EMA200 on 15m/1h and recent negative returns. Shorting new breakdowns below recent lows with volume confirmation exploits momentum. OKX futures allow tight stops above resistance.",
