...
class AIGeneratedLongVolatilityBreakout(SampleStrategy):
    """
    ...
    can_short = True
    minimal_roi = {"0": 0.038, "30": 0.018, "90": 0.0}
    stoploss = -0.07
    trailing_stop = True
    ...
    "archetype": "breakout",
    "bb_tolerance": 0.002,
    "class_name": "AIGeneratedLongVolatilityBreakout",
    "generated_by": "heuristic",
    "name": "long_volatility_breakout",
